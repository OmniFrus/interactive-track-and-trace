#ifndef SNAPADVECTIONCONDITIONKERNEL_H
#define SNAPADVECTIONCONDITIONKERNEL_H
 ...
 */
class SnapAdvectionConditionKernel: public AdvectionKernel {
...
public:
   ...
   */
  SnapAdvectionConditionKernel(std::unique_ptr<AdvectionKernel> kernel, std::shared_ptr<UVGrid> uvGrid);
